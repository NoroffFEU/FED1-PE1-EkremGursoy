...
export function createCard(id, title, imageUrl, content) {
  ...
  card.addEventListener("click", () => {
    window.location.href =
      "/FED1-PE1-EkremGursoy/post/single-post.html?id=" + id;
  });
  ...
  readMoreLink.href = "/FED1-PE1-EkremGursoy/post/single-post.html?id=" + id;
...
export function createAdminCard(id, title, imageUrl, content) {
  ...
  editLink.href = "/FED1-PE1-EkremGursoy/post/edit.html?id=" + id;
